...
class Guide(commands.Cog):
    ...
    def _build_guide_batches(self) -> list[list[discord.Embed]]:
        ...
        e3.add_field(name="/globalrank top",          value="Global leaderboard with 4 tabs: **Top Balance** (current yuan held across all servers), **Top Earned** (yuan earned — 7D / 30D / All-Time window dropdown), **Top Score** (average score across all servers), **Top Citizens** (composite avg score + total balance). Names are hidden by default.", inline=False)
